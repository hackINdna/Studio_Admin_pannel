...
// import studioIconImage from './images/f2.jpg';
                ...
                <div className="main-white-left1">
                    <section className="popular-studios1">
                        ...
                        <div className="scroll-area">
                            <div className="p-s-studio-details1">
                                <span>Paras Sharma</span>
                                <span>Gold</span>
                                <span>456</span>
                            </div>
                            ...
                            {/* <div className="studio-desc-admin">
                                <section className="desc-first">
                                    ...
                                    <div className="subs-std">
                                        <h3>Subscription: Platinum</h3>
                                        <span>10 Days left</span>
                                    </div>
                                </section>
                                <section className="desc-second">
                                    <span>Category: Musician</span>
                                    <span>Followers: 2K</span>
                                </section>
...
export default AuditionSubscription
