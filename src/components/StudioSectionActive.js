                ...
                <div className="main-white-left1">
                    <section className="popular-studios1">
                        ...
                        <div className="scroll-area">
                            <div className="p-s-studio-details" onClick={showDetails}>
                            ...
                            <div className="studio-desc-admin" style={details ? visible : notVisible}>
...
export default StudioSectionActive
